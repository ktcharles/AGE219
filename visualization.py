...
plt.savefig('1_trend_analysis.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('2_categorical_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
print("Saved: 2_categorical_comparison.png")
...
plt.savefig('3_correlation_plot.png', dpi=300, bbox_inches='tight')
plt.close()
print(" Saved: 3_correlation_plot.png")

print(" ALL 3 VISUALIZATIONS COMPLETE SO THat MISSION IS ACCOMPLISHED ")
print("=========================================")
print("\nFiles created:")
print(" 1_trend_analysis.png")
print(" 2_categorical_comparison.png")
print(" 3_correlation_plot.png")
